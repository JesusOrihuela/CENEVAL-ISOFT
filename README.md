# Estructura del EGEL Plus en Ingeniería de Software (EGEL Plus ISOFT)
...
## Aspectos que se evalúan en la Sección Disciplinar del EGEL Plus ISOFT
...
## Definición de las áreas disciplinarias

### Área 1. Análisis de Sistemas de Software

Se abordan los conceptos, técnicas y herramientas para **identificar, validar, priorizar y documentar** los objetivos y límites del sistema, así como los **diferentes tipos de requerimientos** que caracterizan su funcionamiento.

### Área 2. Diseño de Sistemas de Software

Se abordan los conceptos, métodos, técnicas y herramientas relacionados con la **definición, validación y documentación del diseño** de un sistema en términos de su **arquitectura, módulos, componentes, interfaces y datos** para conducir la construcción de este.

### Área 3. Desarrollo de Sistemas de Software

Comprende las etapas de **implementación, pruebas y despliegue** del ciclo de desarrollo de software, realizando su **respectiva documentación** y empleando las **arquitecturas y entornos de desarrollo** donde se contemple el resultado de la etapa de diseño.
...
4. ✅ Davis, A. M. (2013). *Just enough requirements management: Where software development meets marketing*. Dorset House Publishing.
5. ✅ Gómez, J. (2014). *Guía práctica de estimación y medición de proyectos Software: ¿Por qué?, ¿Para qué? y ¿Cómo?* Edición del autor.
6. ❌ Hatton, S. (2008). *Choosing the right prioritisation method*. Proceeding of the Australian Software Engineering Conference (ASWEC).
7. ✅ Kerzner, H. (2009). *Project management: A systems approach to planning, scheduling, and controlling*. John Wiley & Sons.
8. ✅ McConnell, S. (s.f.). *Code Complete Checklist: Requirements*. Matthewjmiller.
9. ✅ Patton, J. (2014). *User story mapping: Discover the whole story, build the right product*. O’Reilly.
10. ✅ Pressman, R. (2010). *Ingeniería de software* (7a ed.). McGraw-Hill.
11. ✅ Rohrer, C. (2014). *When to use which user-experience research methods*. Nielsen Norman Group.
12. ✅ Sommerville, I. (2011). *Ingeniería de software* (9a ed.). Pearson.
13. ✅ SysML (s.f.). *What is the systems language (SysML)?*
14. ✅ Usman, M., Mendes, E., & Börstler, J. (2015). *Effort estimation in agile software development: A survey on the state of the practice*. Proceedings of EASE ’15.
15. ✅ Visual Paradigm (s.f.). *What is user story?*
...
4. ✅ Cervantes, H., Velasco-Elizondo, P., & Castro, L. (2016). *Arquitectura de software, conceptos y ciclo de desarrollo*. Cengage Learning.
5. ✅ Clements, P., Bachmann, F., Bass, L., Garlan, D., Ivers, J., Little, R., et al. (2003). *Documenting software architectures, views and beyond* (2a ed.). Addison-Wesley.
6. ✅ Date, C. J. (2001). *Introducción a los sistemas de bases de datos*. Pearson Educación; Prentice Hall.
7. ✅ Folmer, E., Van Gurp, J., & Bosch, J. (2003). *Scenario-based assessment of software architecture usability*. Workshop on Bridging the Gaps Between SE and HCI (ICSE).
8. ✅ Harrington, J. L. (2016). *Relational database design and implementation: Clearly explained*. Morgan Kaufmann.
9. ✅ Ingeno, J. (2018). *Software architect’s handbook*. Packt.
10. ✅ Jacko, J. (Ed.) (2012). *Human computer interaction handbook* (3a ed.). CRC Press.
11. ✅ Jacobson, I., Spencer, I., & Bittner, K. (2011). *USE-CASE 2.0. The guide to succeeding with use cases*. Edición del autor.
12. ✅ Joyanes, L., & Zahonero, I. (2014). *Programación en C, C++, Java y UML*. McGraw-Hill.
13. ✅ Kruchten, P. (1995). *Architectural Blueprints: The “4+1” view model of software architecture*. *IEEE Software*, 12(6), 42–50.
14. ✅ McCloskey, M. (2014). *Turn user goals into task scenarios for usability testing*. Nielsen Norman Group.
15. ✅ Nielsen, J. (1994). *10 usability heuristics for user interface design*. Nielsen Norman Group.
16. ✅ Pascual, J. R. (2019). *Acoplamiento y cohesión*. Disrupción tecnológica.
...
4. ✅ EcuRed (2021). *Lenguaje de programación Haskell*.
5. ✅ Gbdirect (2021). *The C Book. Table of contents*.
6. ✅ Juganaru, M. (2021). *Introducción a la programación*. Editorial Patria.
7. ✅ Ladrón de Guevara, J. (2020). *Fundamentos de programación en Java*. Universidad Complutense de Madrid.
8. ✅ Laudon, J. P., & Laudon, K. C. (2004). *Sistemas de información gerencial: Administración de la empresa digital*. Prentice Hall.
9. ❌ Martí, N., Ortega, Y., & Verdejo, L. (2004). *Estructuras de datos y métodos algorítmicos: Ejercicios resueltos*. Pearson Educación.
10. ✅ Meier, A., & Kaufmann, M. (2019). *SQL e NoSQL databases: Models, languages, consistency options and architectures for big data management*. Springer Vieweg.
11. ✅ O’Hanlon, P. (2019). *Advanced TypeScript Programming Projects*. Packt.
12. ✅ Pereira, E., Fontenla, O., & Fariña, A. (2008). *Introducción a la programación con Java* [diapositivas de PowerPoint]. Universidad de la Coruña.
13. ✅ Python (2022). *Comparing Python to other languages*. Python.
...
8. ❌ Escudero, X. (2015). *Calidad del software: Técnicas de prevención, detección y corrección de defectos*. Universitat Oberta de Catalunya.
9. ✅ Extreme Programming (2009). *Extreme Programming: A gentle introduction*.
10. ✅ Gamboa-Carrascal, J., & Rosado, A. A. (2015). *Diseño de un método ágil de desarrollo de software basado en XP, SCRUM, OPENUP y validado con la herramienta de análisis 4-dat*. *Revista Ingenio*.
11. ✅ García, J. (2018). *Estudio comparativo de metodologías, herramientas y wiki de soporte para la gestión de proyectos de desarrollo software*. Universitat Oberta de Catalunya.
12. ✅ Garita, G., & Lizano, F. (2018). *Estimación de costo de software: Una propuesta de aplicación pedagógica de COCOMO*.
13. ✅ Hilera, J. R. (s.f.). *Métricas de la documentación del software*.
14. ❌ Kaizenia (2021). *¿Qué son los artefactos de Scrum?*
15. ✅ Maida, E., & Paciencia, J. (2015). *Metodologías de desarrollo de software* [Tesis de licenciatura, Universidad Católica Argentina].
16. ✅ OpenUp (2013). *Metodología Open Up*.
17. ✅ Ramírez, E. (s.f.). *Metodología RUP*.
